                ...
                <div className='row gy-5 justify-content-center align-items-center'>
                    ...
                    <div className='col-xl-6'>
                        ...
                        <div className='about__content-three mt-50'>
                            <p>
                                Commodo metus auctor potenti sapien eget porttitor, elementum semper cubilia lacinia
                                praesent dis hac dui, nisi ridiculus lobortis purus primis platea. Suscipit ultricies
                                pellentesque hendrerit lectus habitant mattis aenean, quis justo odio blandit vitae
                                nascetur a, vulputate aptent.
                            </p>
                        </div>
