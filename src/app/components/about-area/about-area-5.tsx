                        ...
                        <div className='col-xl-6'>
                            <div className='text-xl-start text-center'>
                                ...
                                <div className='about__content-three'>
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis elementum sollici
                                        tudin augue euismod. Nulla ullamcorper nunc. Morbi pharetra mi eu tellus mollis,
                                        tincidunt massa venenatis. Etiam lacinia ipsumultrices.
                                    </p>
                                </div>
