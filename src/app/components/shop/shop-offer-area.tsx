...
export default function ShopOfferArea() {
    return (
        <section
            className='offer__area fix bg-img-cover bg-img-center'
            style={{ backgroundImage: `url(/assets/img/bg/offer_bg5.png)` }}
        >
                ...
                <div className='row justify-content-center flex-row-reverse'>
                    <div className='col-xl-5'>
                        <div className='section__title text-center title-shape-none'>
                            ...
                            <p>
                                Register for your newsletter today to stay updated on your latest product release and
                                exclusive offers
                            </p>
