            ...
            <div className='shop__widget'>
                ...
                <div className='shop__widget-inner'>
                    <div className='shop__price-filter'>
                        <div id='slider-range'>
                            <InputRange MAX={380} MIN={0} STEP={1} values={priceValue} handleChanges={handleChanges} />
                        </div>
            ...
            <div className='shop__widget'>
                ...
                <div className='shop__widget-inner'>
                    <ul className='product-categories list-wrap'>
                        <li>
                            <Link href='/shop'>controller</Link>
                            <span className='float-right'>12</span>
                        </li>
                        <li>
                            <Link href='/shop'>Headphone</Link>
                            <span className='float-right'>03</span>
                        </li>
                        <li>
                            <Link href='/shop'>TOURNAMENTS</Link>
                            <span className='float-right'>18</span>
                        </li>
                        <li>
                            <Link href='/shop'>E-SPORTS</Link>
