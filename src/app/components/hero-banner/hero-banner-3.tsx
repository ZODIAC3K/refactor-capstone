        ...
        <MouseParallaxContainer>
            <section className='banner__area banner__area-two'>
                <div
                    ...
                    style={{ backgroundImage: `url(/assets/img/slider/banner_bg_shape3-2.jpg)` }}
                >
                    ...
                    <div className='row gy-5 align-items-center flex-row-reverse'>
                        <div className='col-xl-6'>
                            <MouseParallaxChild
                                factorX={0.03}
                                factorY={0.03}
                                className='banner__img wow bounceInRight'
                                data-magnetic
                                data-wow-delay='.4s'
                            >
                        ...
                        <div className='col-xl-6'>
                            <div className='banner__content slider__content'>
                                ...
                                <p className='wow bounceInLeft' data-wow-delay='.4s'>
                                    Lorem ipsum dolor sit amet consectetur adipiscing elit, non parturient nulla
                                    eleifend in sagittis, torquent semper cubilia cras donec vehicula. Ultrices cubilia
                                    venenatis mattis senectus vestibulum etiam...
                                </p>
