...
export default function TeamAreaTwo({ style_2 = false }: IProps) {
    return (
        <section
            className={`${style_2 ? 'team__area4' : 'team__area3 section-pt-120'} section-pb-120`}
        ...
        >
            <div className='container'>
                ...
                <div className='row gy-4 justify-content-center'>
                    {teamData.map((team) => (
                        <div key={team.id} className='col-xl-4 col-md-6 wow fadeInUp' data-wow-delay={team.delay}>
